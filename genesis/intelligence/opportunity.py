...
from .discovery.competitors import CompetitorAnalyzer
from .discovery.market_research import MarketResearchConnector
from .discovery.trends import TrendMonitor
