...
from .scorers.competition import CompetitionScorer
from .scorers.market import MarketScorer
from .scorers.risk import RiskScorer
...
class VentureDecisionEngine:
    ...
    def evaluate(self, idea: str, context: Dict[str, Any] | None = None, customer_intelligence: Dict[str, Any] | None = None) -> VentureDecision:
        ...
        icp = ci.get("icp", {})
        fit_score = icp.get("fit_score", 50.0) if isinstance(icp, dict) else getattr(icp, "fit_score", 50.0)
